  ...
  properties: {
    length: {
      doc: {
        ...
        examples: [
          { example: "['Bob', 'Bill', 'Nat'].length", evaluated: "3" },
        ],
        docURL:
  ...
  functions: {
        ...
        args: [
          {
            ...
            variadic: true,
            description:
              "The arrays to be joined on the end of the base array, in order",
            type: "Array",
          },
        ],
      },
    ...
    filter: {
      doc: {
        ...
        examples: [
          ...
          {
            example:
              "['Nathan', 'Bob', 'Sebastian'].filter(name => name.length < 5)",
            evaluated: "['Bob']",
            description:
          ...
          {
            example:
              "[1, 7, 3, 10, 5].filter((num, index) =>  index % 2 !== 0)",
            evaluated: "[7, 10]",
        ...
        args: [
          {
            ...
            args: [
              ...
              },
              {
                ...
                optional: true,
                description:
                  "The position of the current element in the array (starting at 0)",
                type: "number",
              },
              {
                name: "array",
    ...
    find: {
      doc: {
        ...
        examples: [
          ...
          {
            example:
              "['Nathan', 'Bob', 'Sebastian'].find(name => name.length < 5)",
            evaluated: "'Bob'",
            description:
    ...
    findLast: {
      doc: {
        ...
        hidden: true,
        description:
          "Returns the value of the last element that passes the test `fn`.",
        docURL:
    ...
    map: {
      doc: {
        ...
        examples: [
          ...
          {
            example:
              "['hello', 'old', 'chap'].map(function(word) { return word.toUpperCase() })",
            evaluated: "['HELLO', 'OLD', 'CHAP']]",
            description: "Or using traditional function notation",
          },
        ],
