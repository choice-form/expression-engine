  ...
  functions: {
    ...
    replaceAll: {
      doc: {
        ...
        examples: [
          ...
          {
            example:
              "text.replaceAll(/blue|car/gi, function(x){return x.toUpperCase()})",
            evaluated: "'Mr BLUE has a BLUE CAR'",
        ...
        args: [
          {
            ...
            optional: false,
            description:
              "The text to check against the start of the base string",
            type: "string",
          },
          {
            name: "start",
    ...
    trimEnd: {
      doc: {
        ...
        examples: [
          { example: "'   lonely   '.trimEnd()", evaluated: "'   lonely'" },
        ],
        section: "edit",
        docURL:
    ...
    trimStart: {
      doc: {
        ...
        examples: [
          { example: "'   lonely   '.trimStart()", evaluated: "'lonely   '" },
        ],
        section: "edit",
        docURL:
