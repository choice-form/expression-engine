...
import { ExpressionError, ExpressionExtensionError } from "../errors";
...
function unique(value: unknown[], extraArgs: string[]): unknown[] {
  ...
  return uniqWith(value, (a, b) =>
    isEqual(mapForEqualityCheck(a), mapForEqualityCheck(b))
  );
}
...
function merge(value: unknown[], extraArgs: unknown[][]): unknown {
  ...
  const listLength =
    value.length > others.length ? value.length : others.length;
  let merged = {};
...
average.doc = {
  ...
  returnType: "number",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-average",
};
...
compact.doc = {
  ...
  returnType: "Array",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-compact",
};
...
isEmpty.doc = {
  ...
  returnType: "boolean",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-isEmpty",
};
...
isNotEmpty.doc = {
  ...
  returnType: "boolean",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-isNotEmpty",
};
...
first.doc = {
  ...
  examples: [
    { example: "['quick', 'brown', 'fox'].first()", evaluated: "'quick'" },
  ],
  returnType: "any",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-first",
};
...
last.doc = {
  ...
  examples: [
    { example: "['quick', 'brown', 'fox'].last()", evaluated: "'fox'" },
  ],
  returnType: "any",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-last",
};
...
max.doc = {
  ...
  returnType: "number",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-max",
};
...
min.doc = {
  ...
  returnType: "number",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-min",
};
...
randomItem.doc = {
  ...
  returnType: "any",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-randomItem",
};
...
sum.doc = {
  ...
  returnType: "number",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-sum",
};
...
chunk.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-chunk",
};
...
difference.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-difference",
};
...
merge.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-merge",
};
...
pluck.doc = {
  ...
  examples: [
    {
      example:
        "[{ name: 'Nathan', age: 42 },{ name: 'Jan', city: 'Berlin' }].pluck('name')",
      evaluated: '["Nathan", "Jan"]',
    },
    {
      example:
        "[{ name: 'Nathan', age: 42 },{ name: 'Jan', city: 'Berlin' }].pluck('age')",
      evaluated: "[42]",
    },
  ],
  returnType: "Array",
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-pluck",
};
...
renameKeys.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-renameKeys",
};
...
smartJoin.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-smartJoin",
};
...
union.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-union",
};
...
unique.doc = {
  ...
  examples: [
    ...
    {
      example:
        "[{ name: 'Nathan', age: 42 }, { name: 'Nathan', age: 22 }].unique()",
      evaluated: "[{ name: 'Nathan', age: 42 }, { name: 'Nathan', age: 22 }]",
    },
    {
      example:
        "[{ name: 'Nathan', age: 42 }, { name: 'Nathan', age: 22 }].unique('name')",
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-unique",
  args: [
    {
      name: "fieldNames",
      optional: false,
...
append.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/arrays/#array-append",
  returnType: "Array",
  args: [
    {
      name: "elements",
