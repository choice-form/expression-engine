...
function keepFieldsContaining(value: object, extraArgs: string[]): object {
  ...
  for (const [key, val] of Object.entries(value)) {
    if (
      typeof val !== "string" ||
      (typeof val === "string" && !val.includes(match))
    ) {
...
compact.doc = {
  ...
  examples: [
    { example: "({ x: null, y: 2, z: '' }).compact()", evaluated: "{ y: 2 }" },
  ],
  returnType: "Object",
  docURL:
...
keys.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/objects/#object-keys",
  returnType: "Array",
};
...
values.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/objects/#object-values",
  returnType: "Array",
};
