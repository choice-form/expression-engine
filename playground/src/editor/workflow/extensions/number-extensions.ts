  ...
  switch (valueFormat) {
    ...
    case "excel": {
      ...
      return DateTime.fromSeconds(
        (value - (DAYS_BETWEEN_1900_1970 + DAYS_LEAP_YEAR_BUG_ADJUST)) *
          SECONDS_IN_DAY
      );
    }
    case "s":
...
ceil.doc = {
  ...
  returnType: "number",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/numbers/#number-ceil",
};
...
floor.doc = {
  ...
  returnType: "number",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/numbers/#number-floor",
};
...
isEven.doc = {
  ...
  returnType: "boolean",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/numbers/#number-isEven",
};
...
isOdd.doc = {
  ...
  returnType: "boolean",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/numbers/#number-isOdd",
};
...
format.doc = {
  ...
  examples: [
    ...
    {
      example:
        "(123456.789).format('de-DE', {'style': 'currency', 'currency': 'EUR'})",
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/numbers/#number-format",
};
...
round.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/numbers/#number-round",
};
...
abs.doc = {
  ...
  returnType: "number",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/numbers/#number-abs",
};
