...
import { tryToParseDateTime } from "./utils";
...
length.doc = {
  ...
  returnType: "number",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/strings",
};
...
extractUrlPath.doc = {
  ...
  examples: [
    ...
    {
      example:
        '"Check out http://n8n.io/workflows".extractUrl().extractUrlPath()',
      evaluated: "'/workflows'",
    },
  ],
};
...
toNumber.doc = {
  ...
  returnType: "number",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-toNumber",
  examples: [
