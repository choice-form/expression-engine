...
function generateDurationObject(
...
function extract(date: Date | DateTime, args: DatePart[]): number {
  ...
  if (part === "yearDayNumber") {
    ...
    const diff =
      ...
      (firstDayOfTheYear.getTimezoneOffset() - date.getTimezoneOffset()) *
        60 *
        1000;
...
function isInLast(date: Date | DateTime, extraArgs: unknown[]): boolean {
  const [durationValue = 0, unit = "minutes"] = extraArgs as [
    number,
    DurationUnit,
  ];

  const dateInThePast = DateTime.now().minus(
    generateDurationObject(durationValue, unit)
  );
  let thisDate = date;
...
function diffTo(
  date: DateTime,
  args: [string | Date | DateTime, DurationUnit | DurationUnit[]]
) {
...
endOfMonth.doc = {
  ...
  section: "edit",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-endOfMonth",
};
...
isDst.doc = {
  ...
  section: "query",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-isDst",
};
...
isWeekend.doc = {
  ...
  section: "query",
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-isWeekend",
};
...
beginningOf.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-beginningOf",
};
...
extract.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-extract",
};
...
format.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-format",
};
...
isBetween.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-isBetween",
};
...
isInLast.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-isInLast",
};
...
toDateTime.doc = {
  ...
  examples: [
    {
      example:
        "jsDate = new Date('2024-03-30T18:49')\njsDate.toDateTime().plus(5, 'days')",
  ...
  hidden: true,
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-toDateTime",
};
...
minus.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-minus",
};
...
plus.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-plus",
};
...
diffTo.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-diffTo",
};
...
diffToNow.doc = {
  ...
  docURL:
    "https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-diffToNow",
};
