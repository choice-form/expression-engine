...
export const luxonStaticDocs: Required<NativeDoc> = {
  ...
  functions: {
    now: {
      doc: {
        name: "now",
        description: "codeNodeEditor.completer.luxon.dateTimeStaticMethods.now",
        docURL:
    ...
    utc: {
      doc: {
        name: "utc",
        description: "codeNodeEditor.completer.luxon.dateTimeStaticMethods.utc",
        docURL:
          "https://moment.github.io/luxon/api-docs/index.html#datetimeutc",
        returnType: "DateTime",
        args: [
          {
            name: "year",
    ...
    fromSeconds: {
      doc: {
        ...
        docURL:
          "https://moment.github.io/luxon/api-docs/index.html#datetimefromseconds",
        returnType: "DateTime",
        args: [
          {
            name: "seconds",
    ...
    invalid: {
      doc: {
        name: "invalid",
        docURL:
          "https://moment.github.io/luxon/api-docs/index.html#datetimeinvalid",
        returnType: "DateTime",
        hidden: true,
        args: [
    ...
    isDateTime: {
      doc: {
        ...
        docURL:
          "https://moment.github.io/luxon/api-docs/index.html#datetimeisdatetime",
        returnType: "boolean",
        args: [
          {
            name: "maybeDateTime",
    ...
    expandFormat: {
      doc: {
        name: "expandFormat",
        docURL:
          "https://moment.github.io/luxon/api-docs/index.html#datetimeexpandformat",
        returnType: "string",
        hidden: true,
        args: [
          { name: "fmt", type: "any" },
    ...
    fromFormatExplain: {
      doc: {
        ...
        docURL:
          "https://moment.github.io/luxon/api-docs/index.html#datetimefromformatexplain",
        returnType: "Object",
        hidden: true,
        args: [
          { name: "text", type: "string" },
    ...
    fromString: {
      doc: {
        name: "fromString",
        docURL:
          "https://moment.github.io/luxon/api-docs/index.html#datetimefromstring",
        returnType: "DateTime",
        hidden: true,
        args: [
          { name: "text", type: "string" },
    ...
    fromStringExplain: {
      doc: {
        ...
        docURL:
          "https://moment.github.io/luxon/api-docs/index.html#datetimefromstringexplain",
        returnType: "Object",
        hidden: true,
        args: [
          { name: "text", type: "string" },
    ...
    max: {
      doc: {
        name: "max",
        description: "codeNodeEditor.completer.luxon.dateTimeStaticMethods.max",
        docURL:
    ...
    min: {
      doc: {
        name: "min",
        description: "codeNodeEditor.completer.luxon.dateTimeStaticMethods.min",
        docURL:
    ...
    parseFormatForOpts: {
      doc: {
        ...
        docURL:
          "https://moment.github.io/luxon/api-docs/index.html#datetimeparseformatforopts",
        returnType: "string",
        hidden: true,
        args: [
          { name: "fmt", type: "any" },
