...
import type { DocMetadata, NativeDoc, IDataObject } from "@/editor/types";
import {
...
import {
  luxonInstanceDocs,
  luxonStaticDocs,
} from "./natives-autocomplete-docs";
import { getVariablesStore } from "@/editor/store";
import {
  NATIVE_METHODS,
  EXPRESSION_EXTENSIONS,
  validateFieldType,
} from "@/editor/workflow";
import { isPairedItemIntermediateNodesError } from "@/editor/workflow/expression/utils";
...
export function datatypeCompletions(
  ...
  if (base === "DateTime") {
    ...
    options = attempt(
      () =>
        datatypeOptions({ resolved, base, tail }).map(
...
export const natives = ({
  ...
  const nativeDocs = NATIVE_METHODS.find(
...
export const extensions = ({
  ...
  const expressionExtensions = EXPRESSION_EXTENSIONS.find(
    (ee) => ee.typeName.toLowerCase() === typeName
  );
...
export const toOptions = ({
  ...
  return Object.entries(fnToDoc)
    ...
    .filter(
      ([, docInfo]) =>
        Boolean(docInfo.doc && !docInfo.doc?.hidden) || includeHidden
    )
    .map(([fnName, docInfo]) => {
...
const applySections = ({
  ...
  return recommended
    .map((reco): Completion => {
      const option =
        optionByLabel[typeof reco === "string" ? reco : reco.label];
      const label =
        typeof reco === "string"
          ? option.label
          : insertDefaultArgs(reco.label, reco.args);
      return { ...option, label, section: recommendedSection };
    })
    .concat(
      options
        .filter(
          (option) => !excludeRecommended || !recommendedSet.has(option.label)
        )
        .map((option) => {
          if (sections) {
            option.section =
              sections[option.section as string] ?? OTHER_SECTION;
          } else {
            option.section = option.label.endsWith("()")
              ? methodsSection
              : propSection;
          }
          return option;
  ...
  if (resolved && validateFieldType("string", resolved, "number").valid) {
    ...
    if (timestampUnit) {
      return applySections({
        ...
        recommended: [
          ...recommended,
          { label: "toDateTime()", args: [`'${timestampUnit}'`] },
        ],
...
export const variablesOptions = () => {
  const variableStore = getVariablesStore();
  ...
  return variables.map((variable) =>
    createCompletionOption({
      ...
      doc: {
        name: variable.key,
        returnType: "string",
        description: "codeNodeEditor.completer.$vars.varName",
  ...
  return [
    {
      ...
      description: "codeNodeEditor.completer.$response.statusCode",
    },
    {
      name: "statusMessage",
      returnType: "string",
      description: "codeNodeEditor.completer.$response.statusMessage",
    },
    {
      name: "headers",
      returnType: "Object",
      docURL: "https://docs.n8n.io/code/builtin/http-node-variables/",
      description: "codeNodeEditor.completer.$response.headers",
    },
    {
      name: "body",
      returnType: "Object",
      docURL: "https://docs.n8n.io/code/builtin/http-node-variables/",
      description: "codeNodeEditor.completer.$response.body",
    },
  ...
  return [
    {
      name: "id",
      returnType: "string",
      description: "codeNodeEditor.completer.$execution.id",
    },
    {
      name: "mode",
      returnType: "string",
      description: "codeNodeEditor.completer.$execution.mode",
    },

    {
      ...
      description: "codeNodeEditor.completer.$execution.resumeUrl",
    },
    {
      name: "resumeFormUrl",
      returnType: "string",
      docURL:
        "https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.wait/",
      description: "codeNodeEditor.completer.$execution.resumeFormUrl",
    },
    {
      name: "customData",
      ...
      description: "codeNodeEditor.completer.$execution.customData",
    },
  ].map((doc) => createCompletionOption({ name: doc.name, doc }));
};
  ...
  return [
    {
      ...
      description: "codeNodeEditor.completer.$execution.customData.get",
      examples: [
        {
          description:
    ...
    },
    {
      ...
      args: [
        {
          name: "key",
          description:
            "codeNodeEditor.completer.$execution.customData.set.args.key",
          type: "string",
        },
        {
          name: "value",
      ...
      docURL:
        "https://docs.n8n.io/workflows/executions/custom-executions-data/",
      description: "codeNodeEditor.completer.$execution.customData.set",
      examples: [
        {
          description:
    ...
    },
    {
      ...
      docURL:
        "https://docs.n8n.io/workflows/executions/custom-executions-data/",
      description: "codeNodeEditor.completer.$execution.customData.getAll",
      examples: [
        {
    ...
    },
    {
      ...
      docURL:
        "https://docs.n8n.io/workflows/executions/custom-executions-data/",
      description: "codeNodeEditor.completer.$execution.customData.setAll",
      examples: [
        {
          example:
    ...
    createCompletionOption({ name: doc.name, doc, isFunction: true })
  );
};
...
export const nodeRefOptions = (base: string) => {
  const itemArgs = [
    {
      name: "branchIndex",
      optional: true,
      description: "codeNodeEditor.completer.selector.args.branchIndex",
      default: "0",
      type: "number",
    },
    {
      name: "runIndex",
      optional: true,
      description: "codeNodeEditor.completer.selector.args.runIndex",
      default: "0",
      type: "number",
    },
  ];
  ...
  const options: Array<{ doc: DocMetadata; isFunction?: boolean }> = [
    {
      doc: {
        ...
        description: "codeNodeEditor.completer.selector.item",
      },
    },
    {
      doc: {
        name: "isExecuted",
        returnType: "boolean",
        description: "codeNodeEditor.completer.selector.isExecuted",
      },
    },
    {
      doc: {
        ...
        description: "codeNodeEditor.completer.selector.params",
      },
    },
    {
      doc: {
        ...
        docURL: "https://docs.n8n.io/data/data-mapping/data-item-linking/",
        description: "codeNodeEditor.completer.selector.itemMatching",
      },
      isFunction: true,
    },
    {
      doc: {
        ...
        returnType: "Item",
        args: itemArgs,
        description: "codeNodeEditor.completer.selector.first",
      },
      isFunction: true,
    },
    {
      doc: {
        ...
        returnType: "Item",
        args: itemArgs,
        description: "codeNodeEditor.completer.selector.last",
      },
      isFunction: true,
    },
    {
      doc: {
        ...
        returnType: "Item[]",
        args: itemArgs,
        description: "codeNodeEditor.completer.selector.all",
      },
      isFunction: true,
    },
  ];
  ...
  return applySections({
    options: options
      ...
      .map(({ doc, isFunction }) =>
        createCompletionOption({ name: doc.name, doc, isFunction })
      ),
    sections: {},
    recommended: ["item"],
  });
  ...
  return [
    {
      name: "name",
      returnType: "string",
      description: "codeNodeEditor.completer.$prevNode.name",
    },
    {
      name: "outputIndex",
      returnType: "number",
      description: "codeNodeEditor.completer.$prevNode.outputIndex",
    },
    {
      name: "runIndex",
      returnType: "number",
      description: "codeNodeEditor.completer.$prevNode.runIndex",
    },
  ].map((doc) => createCompletionOption({ name: doc.name, doc }));
};
  ...
  return [
    {
      ...
      description: "codeNodeEditor.completer.item.json",
    },
    {
      name: "binary",
      returnType: "Object",
      docURL: "https://docs.n8n.io/data/data-structure/",
      description: "codeNodeEditor.completer.item.binary",
    },
  ].map((doc) => createCompletionOption({ name: doc.name, doc }));
};
  ...
  return [
    {
      name: "id",
      returnType: "String",
      description: "codeNodeEditor.completer.binary.id",
    },
    {
      name: "fileExtension",
      returnType: "string",
      description: "codeNodeEditor.completer.binary.fileExtension",
    },
    {
      name: "fileName",
      returnType: "string",
      description: "codeNodeEditor.completer.binary.fileName",
    },
    {
      name: "fileSize",
      returnType: "string",
      description: "codeNodeEditor.completer.binary.fileSize",
    },
    {
      name: "fileType",
      returnType: "String",
      description: "codeNodeEditor.completer.binary.fileType",
    },
    {
      name: "mimeType",
      returnType: "string",
      description: "codeNodeEditor.completer.binary.mimeType",
    },
    {
      name: "directory",
      returnType: "String",
      description: "codeNodeEditor.completer.binary.directory",
    },
  ].map((doc) => createCompletionOption({ name: doc.name, doc }));
};
  ...
  return [
    {
      name: "id",
      returnType: "string",
      description: "codeNodeEditor.completer.$workflow.id",
    },
    {
      name: "name",
      returnType: "string",
      description: "codeNodeEditor.completer.$workflow.name",
    },
    {
      name: "active",
      returnType: "boolean",
      description: "codeNodeEditor.completer.$workflow.active",
    },
  ].map((doc) => createCompletionOption({ name: doc.name, doc }));
};
...
//           description: "codeNodeEditor.completer.$secrets.provider.varName",
//           docURL: "settings.externalSecrets.docs",
//         },
//       })
//     );
//   } catch {
...
//         name: provider,
//         returnType: "Object",
//         description: "codeNodeEditor.completer.$secrets.provider",
//         docURL: "settings.externalSecrets.docs",
//       },
//     })
//   );
...
const createLuxonAutocompleteOption = ({
  ...
  if (
    docs.properties &&
    Object.prototype.hasOwnProperty.call(docs.properties, name)
  ) {
    doc = docs.properties[name].doc;
  } else if (Object.prototype.hasOwnProperty.call(docs.functions, name)) {
...
export const objectGlobalOptions = () => {
  return [
    {
      name: "assign",
      description: "codeNodeEditor.completer.globalObject.assign",
      args: [
        {
          name: "target",
          type: "object",
    ...
    },
    {
      ...
      description: "codeNodeEditor.completer.globalObject.entries",
      docURL:
    ...
    },
    {
      ...
      returnType: "string[]",
      description: "codeNodeEditor.completer.globalObject.keys",
      docURL:
    ...
    },
    {
      ...
      description: "codeNodeEditor.completer.globalObject.values",
      returnType: "Array",
      docURL:
